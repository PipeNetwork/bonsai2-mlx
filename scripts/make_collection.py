"""Create the Hugging Face collection for the Ternary-Bonsai-2 MLX builds (dry run without --yes)."""
from __future__ import annotations
import argparse
NAMESPACE, TITLE = "pipenetwork", "Ternary-Bonsai-2 MLX"
DESCRIPTION = ("Stock-runtime MLX builds of Ternary-Bonsai-2-27B: Hadamard rotation unfolded so unmodified mlx-vlm loads it. "
               "github.com/PipeNetwork/bonsai2-mlx")
